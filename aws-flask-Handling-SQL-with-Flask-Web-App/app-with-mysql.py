...
app.config['MYSQL_DATABASE_HOST'] = 'flask-project-public.cqkbkh2uv4mr.us-east-1.rds.amazonaws.com'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = '1234.asdf'
